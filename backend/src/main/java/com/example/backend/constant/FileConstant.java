...
public class FileConstant {
    ...
    public static final String OBJEKAT_IMAGE_PATH="/objekat/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/backend/user/";
    public static final String OBJEKAT_FOLDER = System.getProperty("user.home") + "/backend/objekat/";
    public static final String DIRECTORY_CREATED = "Created directory for: ";
    public static final String DEFAULT_USER_IMAGE_PATH = "/user/image/profile/";
    public static final String DEFAULT_OBJEKAT_IMAGE_PATH = "/objekat/image/profile/";
